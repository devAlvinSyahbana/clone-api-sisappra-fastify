...
module.exports = async function (fastify, opts) {
  ...
  fastify.get(
    ...
    {
      schema: {
        description: "This is an endpoint for fetching a master global kab kota",
        tags: ["master global"],
        params: {
          description: "Find one master global kab kota id",
          type: "object",
          properties: {
            id: { type: "number" },
          },
    ...
    async (request, reply) => {
      ...
      const exec = await fastify.global.findOneKabKot(id);
