...
module.exports = async function (fastify, opts) {
  ...
  fastify.get(
    ...
    {
      schema: {
        description: "This is an endpoint for filtering a master jenis kegiatan",
        tags: ["master jenis kegiatan"],
        params: {
          description: "Filter master jenis kegiatan by search",
          type: "object",
          properties: {
            q: { type: "string" },
          },
    ...
    async (request, reply) => {
      ...
      const exec = await fastify.master_jenis_kegiatan.filter(q);
