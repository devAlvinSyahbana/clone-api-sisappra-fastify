const jenis_sarana_prasarana = require("../../../services/master/master_jenis_sarana_prasarana");

module.exports = async function (fastify, opts) {
    fastify.register(jenis_sarana_prasarana);

    fastify.get(
        "/find", {
            schema: {
                description: "This is an endpoint for fetching all master jenis sarana prasarana",
        ...
        async (request, reply) => {
            const exec = await fastify.jenis_sarana_prasarana.find();
    ...
    fastify.get(
        ...
        async (request, reply) => {
            ...
            const exec = await fastify.jenis_sarana_prasarana.findone(id);
    ...
    fastify.get(
        "/find-by/:jenis_sarana_prasarana", {
            schema: {
                description: "This is an endpoint for fetching a master jenis sarana prasarana",
                tags: ["master jenis sarana prasarana"],
                params: {
                    description: "Find one master jenis sarana prasarana by jenis sarana prasarana",
                    type: "object",
                    properties: {
                        jenis_sarana_prasarana: {
                            type: "string"
        ...
        async (request, reply) => {
            ...
            const exec = await fastify.jenis_sarana_prasarana.findone_by_jenis_sarana_prasarana(jenis_sarana_prasarana);
    ...
    fastify.post(
        ...
        async (request, reply) => {
            ...
            try {
                await fastify.jenis_sarana_prasarana.create(jenis_sarana_prasarana, created_by);
                reply.send({
                    message: "success",
                    code: 200
                });
    ...
    fastify.put(
        ...
        async (request, reply) => {
            ...
            try {
                await fastify.jenis_sarana_prasarana.update(id, jenis_sarana_prasarana, updated_by);
                reply.send({
                    message: "success",
                    code: 200
                });
    ...
    fastify.delete(
        ...
        async (request, reply) => {
            ...
            try {
                await fastify.jenis_sarana_prasarana.del(id, deleted_by);
                reply.send({
                    message: "success",
                    code: 204
                });
    ...
    fastify.get(
        ...
        async (request, reply) => {
            ...
            const exec = await fastify.jenis_sarana_prasarana.filter(q);
