...
module.exports = async function (fastify, opts) {
  ...
  fastify.get(
    ...
    {
      schema: {
        description: "This is an endpoint for filtering a master jenis korban material",
        tags: ["master jenis korban material"],
        params: {
          description: "Filter master jenis korban material by search",
          type: "object",
          properties: {
            q: { type: "string" },
          },
    ...
    async (request, reply) => {
      ...
      const exec = await fastify.master_jenis_korban_material.filter(q);
