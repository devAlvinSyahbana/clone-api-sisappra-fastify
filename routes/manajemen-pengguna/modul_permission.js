...
module.exports = async function (fastify, opts) {
  ...
  fastify.get(
    ...
    {
      schema: {
        description: "API untuk mengambil seluruh data modul permission",
  ...
  fastify.get(
    "/modul-permission/findone/:id",
    {
      schema: {
        description:
          "Endpoint ini digunakan untuk mengambil data modul permission by id",
        tags: ["modul permission"],
        params: {
  ...
  fastify.post(
    ...
    {
      schema: {
        description: "This is an endpoint for creating data modul permission",
        tags: ["modul permission"],
        body: {
    ...
    async (request, reply) => {
      const { akses_kontrol, nama_permission, status } = request.body;
  ...
  fastify.delete(
    ...
    {
      schema: {
        description: "This is an endpoint for deleting data modul permission",
        tags: ["modul permission"],
        params: {
