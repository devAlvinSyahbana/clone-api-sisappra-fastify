...
const sarana_prasarana = (db) => {
  ...
  const create = (jenis_sarana_prasarana, status_sarana_prasarana, jumlah, kondisi, keterangan, file_dokumentasi) => {
    const query = db.one(
      ...
      [jenis_sarana_prasarana, status_sarana_prasarana, jumlah, kondisi, keterangan, file_dokumentasi]
    );
  ...
  const find_jenis_sarana_prasarana =(jenis_sarana_prasarana) => {
    const query = db.any(
        "select id,jenis_sarana_prasarana from jenis_sarana_prasarana where is_deleted = 0 and jenis_sarana_prasarana ilike '%"+jenis_sarana_prasarana+"%' order by created_at"
    );
    return query;
  };
  const find_kondisi_sarana_prasarana = (kondisi_sarana_prasarana) => {
    const query = db.any(
      "select id,kondisi_sarana_prasarana from kondisi_sarana_prasarana where is_deleted = 0 and kondisi_sarana_prasarana ilike '%"+kondisi_sarana_prasarana+"%' order by created_at"
    );
    return query;
  };
  const find_status_sarana_prasarana = (status_sarana_prasarana) => {
    const query = db.any(
      "select id,status_sarana_prasarana from status_sarana_prasarana where is_deleted = 0 and status_sarana_prasarana ilike '%"+status_sarana_prasarana+"%' order by created_at"
    );
    return query;
  };
  ...
  const update = (id,jenis_sarana_prasarana, status_sarana_prasarana, jumlah, kondisi, keterangan, file_dokumentasi, updated_by) => {
    db.one(
      ...
      [jenis_sarana_prasarana, status_sarana_prasarana, jumlah, kondisi, keterangan, file_dokumentasi, updated_by, id]
    );
  };
  ...
  const del = async (id, deleted_by) => {
    await db.one(
      "DELET sarana_prasarana SET is_deleted = 1, deleted_by = $2, deleted_at = CURRENT_TIMESTAMP WHERE id = $1 RETURNING id",
      [id, deleted_by]
    );
